...
class PidWidget(widgets.Widget):
    """
    A MultiFieldWidget allows to enter lists of data using a certain widget.
    ...
    def __init__(self, widget_id, max_length=None, **kwargs):
        ...
        self.max_length = max_length
        self.errors = {}
        super(PidWidget, self).__init__(**kwargs)
    ...
    def _render_container(self, _context):
        return render_to_string('repository/pid_container.html', _context)
    
    def _render_multifield(self, _context):
        return render_to_string('repository/pid_widget.html', _context)
    ...
    def render(self, name, value, attrs=None):
        ...
        _field_widgets = []
        _field_attrs = {'id': 'id_{0}'.format(name), 'class': 'input',
          'style': self.attrs.get('style', 'width:400px;')}

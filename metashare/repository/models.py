...
from metashare.repository.editor.widgets import MultiFieldWidget, PidWidget
...
class identificationInfoType_model(SchemaModel):
    ...
    identifier = MultiTextField(max_length=100, widget=PidWidget(widget_id=1, max_length=100),
      verbose_name='Identifier',
      help_text='A reference to the resource like a pid or an internal i' \
      'dentifier used by the resource provider',
      blank=False, validators=[validate_matches_xml_char_production],
                                default=a.out,)
...
class PendingEmail(models.Model):
    ...
    addresses = models.CharField(max_length=4096)
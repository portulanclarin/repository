...
from local_settings_saml import CONFIG
...
SAML_ATTRIBUTE_MAPPING = {
    ...
    'urn:mace:dir:attribute-def:cn': ('last_name', 'first_name'),
...
STATICFILES_DIRS = (
    ...
    '{0}/../deps/static/'.format(ROOT_PATH),
)
...
TEMPLATE_CONTEXT_PROCESSORS = (
    ...
    "metashare.repository.context_processors.debug_status",
)
...
OAIPMH_URL = "{}/oaipmh/".format(DJANGO_URL)

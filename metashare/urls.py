...
from metashare.settings import MEDIA_ROOT, DEBUG, DJANGO_BASE, SITEMAP_URL, PRIVACY_INFO
...
urlpatterns = patterns('',
  ...
  url(r'^{0}privacy_statement/$'.format(DJANGO_BASE), 'metashare.views.privacy_statement'),
...
urlpatterns += patterns('metashare.oaipmh.views',
  (r'^{0}oaipmh/'.format(DJANGO_BASE), include('metashare.oaipmh.urls')),
)
...
urlpatterns += patterns('',
    ...
    (r'^test/', 'djangosaml2.views.echo_attributes'), # this is for testing
)
